//Nick Piccolo, CSCI 4200, Spring 2023
            ...
            case "OUT":
               ...
               // IN case 
                ...
                case "ADD":
                    ...
                    //regex variable checker
                    if (!variableToAddName.matches("^[a-zA-Z]\\w*$")) 
                    {
                        System.out.println("Invalid variable name");
                        break;
                    }
                    ...
                    for (int i = 2; i < tokens.length; i++) 
                    {
                        ...
                        if (variableMap.containsKey(variableValue)) 
                        {
                            ...
                            sum += Integer.parseInt(value); // convert stored user string value back into an int for processing
                        } 
                        else
                        {
                            sum += Integer.parseInt(variableValue);
                        }
                    }
                ...
                case "SUB":
                    ...
                    //regex variable checker
                    if (!variableToSubtractName.matches("^[a-zA-Z]\\w*$")) 
                    {
                        System.out.println("Invalid variable name");
                        break;
                    }
                    ...
                    int difference = 0;
                   //confirm that at least 2 values are entered
                    if (tokens.length > 2) 
                    {
                ...
                case "MUL":
                    ...
                    //regex variable checker
                    if (!variableToMultiplyName.matches("^[a-zA-Z]\\w*$")) 
                    {
                        System.out.println("Invalid variable name");
                        break;
                    }
                    ...
                    for (int i = 2; i < tokens.length; i++) 
                    {
                        ...
                        {
                            product *= Integer.parseInt(variableValue);
                        }
                    }
                ...
                case "DIV":
                    ...
                    //regex variable checker
                    if (!variableToDivideName.matches("^[a-zA-Z]\\w*$")) 
                    {
                        System.out.println("Invalid variable name");
                        break;
                    }
                    ...
                    for (int i = 2; i < tokens.length; i++) 
                    {
                        ...
                        if (variableMap.containsKey(variableValue)) 
                        {
                            int index = variableMap.get(variableValue);
                            String value = simulatedMemory[index];
                            if (Integer.parseInt(value) == 0) //error handling for division by 0 for hard int
                            {
                            ...
                            else //next user value as divisor
                            {
                                quotient /= Integer.parseInt(value);
                            }
                        } 
                        ...
                        {
                            if (Integer.parseInt(variableValue) == 0) //error handling for division by 0 for variable
                            {
                                System.out.println("Error: Division by zero");
                                return;
                            }
                ...
                case "STO":
                    ...
                    //regex variable checker
                    if (!variableToStoreName.matches("^[a-zA-Z]\\w*$")) 
                    {
                        System.out.println("Invalid variable name");
                        break;
                    }
...
// References: (Only the java library)
//List (java platform SE 8 ). (2023, January 9). Retrieved February 20, 2023, from https://docs.oracle.com/javase/8/docs/api/java/util/List.html 